...
Sf = [20; 10; 0; 0; 0];     % Terminal Weight Matrix.
Q  = [30; 30; 0; 0; 0];     % State Weight Matrix.
R  = 30;                    % Control Weighting Matrix.


p  = 40;                    % Prediction Horizon.
xf = [0; x_end; V_end; theta_end; gamma_end];       % Terminal State.

% Combine stage parameters into a column array.
pvcost = [xf; Sf; Q; R; p];

% Define initial conditions
x_op_0 = [h0/1000;X0;V0;theta0;gamma0]; 
...
%hbar = waitbar(0,"","CreateCancelBtn", "setappdata(gcbf,""canceling"",1)");
%hbar.Name = "Closed-Loop Simulation (MATLAB)";
...
figure
plot(X_plot,h_plot,'r',x_reference_signal,h_reference_signal/1000,'b')
