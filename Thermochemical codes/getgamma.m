...
%%% Reactions are not considered, only standard air particles are present.
%%% Therefore, only temperatures in the range of 200K-1000K will give
%%% accurate results.
...
elseif P > 100
    A1 = 7.9015679093829 *  10^-2;
    B1 = 1.2130630606963 *  10^2;
    C1 = -2.36518584003546 * 10^4;
    D1 = 1.25191944329465 * 10^6;
    A2 = 3.31006934766052 * 10^2;
    B2 = -2.13360008453752 * 10^5;
    C2 = 4.21913706427567 * 10^7;
    D2 = -2.26028517541403 * 10^9;
    A3 = -9.72790877944002 * 10^4;
    B3 = 9.60494733962022 * 10^7;
    C3 = -2.04344514365252 * 10^10;
    D3 = 1.13084180192825 * 10^12;
    A4 = 8.22547956598205 * 10^6;
    B4 = -1.02758574875423 * 10^10;
    C4 = 2.4471151509164  * 10^12;
    D4 = -1.42077286651882 * 10^14;
