...
from rlv_empirical_data01123 import database
...
class optimizer:
    ...
    def solve(self):
        ...
        prob_cx = self.prob_cx
        prob_mt = self.prob_mt
    ...
    def get_values(self, y, ctrl_data, orb_data, tem_data, aero_data):
        ...
        [alpha, L, D, Qp_kpa, q] = ctrl_data[-1]
        [Rn, m, rho0] = orb_data
        [R, K, T0]    = tem_data
        [S, k]        = aero_data
        ...
        # get the all necessary variables values for the alpha
        alpha = hof[0][0]
