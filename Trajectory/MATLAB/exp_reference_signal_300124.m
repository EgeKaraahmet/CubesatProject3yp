...
kepOut = sim("exponential_model",'Solver',solv_kep,'FixedStep',step_kep);
...
atmOut = sim('exponential_model','Solver',solv_atm,'FixedStep',step_atm,'StartTime','kepOut.time(end)');
