...
%% Initial conditions 
% Input 
m = 6;                    %kg         % spacecraft mass  m = 3 for QURMAN; 6 for our cubesat
A=360.4*10^(-4);            %m^2        % spacecraft cross - sectional area
...
kepOut = sim('Copy_of_SatSim_ARES','Solver',solv_kep,'FixedStep',step_kep);
...
atmOut = sim('Copy_of_SatSim_ARES','Solver',solv_atm,'FixedStep',step_atm,'StartTime','kepOut.time(end)');
