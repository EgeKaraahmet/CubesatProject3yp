function [h_reference_signal,x_reference_signal,time_reference_signal,V_reference_signal,Vz_reference_signal,Vx_reference_signal,gamma_reference_signal,heat1,gload]=dynamical_system(Cd)
    %% Initial conditions 
    % Input 
