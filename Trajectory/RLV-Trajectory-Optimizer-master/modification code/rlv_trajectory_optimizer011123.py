...
# plot results
def plot(times, Y, q_values, dp_values):
    ...
    plt4 = plt.plot(dp_values, cols[0],label="Dynamic pressure")
...
if __name__ == "__main__":
    ...
    control = [] # [alpha, L, D, Qp_kpa, q]
    control.append(c0)

    #const = [] # [Qp_kpa, q]
    #const.append(constraint0)
    ...
    for t_start, t_end in zip(times, times[1:]):
        ...
        # pack args list
        args = [alpha_new, L_new, D_new, Qp_kpa_new, q_new]
        control.append(args)
